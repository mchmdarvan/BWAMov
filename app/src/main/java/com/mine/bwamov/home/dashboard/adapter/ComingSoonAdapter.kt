package com.mine.bwamov.home.dashboard.adapter
...
class ComingSoonAdapter(private var data: List<Soon>,
                        private val listener: (Soon) -> Unit)
    : RecyclerView.Adapter<ComingSoonAdapter.LeagueViewHolder>(){

    //Cek lagi nanti contextnya
    ...
    class LeagueViewHolder(view : View) : RecyclerView.ViewHolder(view) {
        ...
        fun bindItem(data: Soon, listener: (Soon) -> Unit, context: Context, position: Int){
