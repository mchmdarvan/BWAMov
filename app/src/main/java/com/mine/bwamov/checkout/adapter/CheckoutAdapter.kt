package com.mine.bwamov.checkout.adapter
...
class CheckoutAdapter(private var data: List<Checkout>,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): CheckoutAdapter.LeagueViewHolder {
    ...
    override fun onBindViewHolder(holder: CheckoutAdapter.LeagueViewHolder, position: Int) {
        holder.bindItem(data[position], listener, ContextAdapter, position)
    }

    class LeagueViewHolder(view: View) : RecyclerView.ViewHolder(view){

        private val tvKursi: TextView = view.findViewById(R.id.tv_seat)
